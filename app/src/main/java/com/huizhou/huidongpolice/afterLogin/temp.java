...
//        {
//            ActivityStaticFilesList.MyTask m = new ActivityStaticFilesList.MyTask();
//            m.execute();
//
//            //移除搜索焦点
//            searchStaticFilesView.setFocusable(false);
...
//
//                ////////////////////
//                FileDownThread fileDown = new FileDownThread();
//                fileDown.setParam(xmString, dirStr + fileName, Flags.READ_FILE);
//                Thread t = new Thread(fileDown);
//                t.start();
//
//                int i =0;
//                for (; i <= StaticNumber.ONE_THOUNDER; i++)
//                {
//                    Thread.sleep(StaticNumber.ONE_HUNDRED);
//
//                    Object o = CommonCache.dataCache.get(Flags.READ_FILE);
//                    if (null != o)
//                    {
//                        CommonCache.dataCache.remove(Flags.READ_FILE);
//
//                        try
//                        {
//                            openFile(new File(dirStr + fileName));
//                            break;
//                        }
//                        catch (Exception e)
//                        {
...
//                    else
//                    {
//                        if (i == StaticNumber.FIVE_HUNDRED)
//                        {
//                            fileDown.setParam(xmString, dirStr + fileName, Flags.READ_FILE);
//                            Thread t2 = new Thread(fileDown);
//                            t2.start();
//
//                            Thread.sleep(StaticNumber.ONE_HUNDRED);
//                            o = CommonCache.dataCache.get(Flags.READ_FILE);
//                            if (null != o)
//                            {
//                                CommonCache.dataCache.remove(Flags.READ_FILE);
//
...
//                }
//
//                if (i >= StaticNumber.ONE_THOUNDER)
//                {
//                    Toast tos = Toast.makeText(getApplicationContext(), "读取文件失败，请再尝试", Toast.LENGTH_LONG);
...
//        {
//            Toast tos2 = Toast.makeText(ActivityStaticFilesList.this, "正在获取文件，请稍等....", Toast.LENGTH_LONG);
//            tos2.setGravity(Gravity.CENTER, 0, 0);
//            tos2.show();
//        }
//
