...
import com.huizhou.huidongpolice.Request.GetAllAlarmCompanyReq;
...
public class ActivityAlarmCompanycheckbox extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_alarm_company_checkbox);
    ...
    {
        mListView = (ListView) findViewById(R.id.list_main_alarmCompany);
        mMainCkb = (CheckBox) findViewById(R.id.ckb_main_alarmCompany);
    }

    public void getAllAlarmCompany(View view)
    {
        ...
        Intent intent = new Intent(ActivityAlarmCompanycheckbox.this, ActivitySearchMoreFloat.class);
        intent.putExtra("result", sb.toString());
        intent.putExtra("type", "alarmCompany");
    ...
    private void initData()
    {
        ...
        pd.setFlag(Flags.SEARCH_ALL_ALARM_COMPANY);

        GetAllAlarmCompanyReq req = new GetAllAlarmCompanyReq();
        ...
        try
        {
            for (int i = 0; i <= StaticNumber.TWO_ZERO; i++)
            {
                ...
                Object o = CommonCache.dataCache.get(Flags.SEARCH_ALL_ALARM_COMPANY);
                if (null != o)
                {
                    ...
                    CommonCache.dataCache.remove(Flags.SEARCH_ALL_ALARM_COMPANY);
                    break;
                }
                else
                {
                    if (i == StaticNumber.TEN)
                    {
                        ...
                        Thread.sleep(StaticNumber.FIVE_HUNDRED);
                        o = CommonCache.dataCache.get(Flags.SEARCH_ALL_ALARM_COMPANY);
                        if (null != o)
                        {
                            List<String> jingQingList = (List<String>) o;
                            Model model;
    ...
    {
        checkboxAdapter = new CheckboxAdapter(models, this, new ActivityComformXingzhiCheckbox.AllCheckListener()
        {
